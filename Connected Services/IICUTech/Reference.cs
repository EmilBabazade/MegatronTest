...
namespace IICUTech
{
    ...
    public partial class ICUTechClient : System.ServiceModel.ClientBase<IICUTech>, IICUTech
    {
        ...
        public System.Threading.Tasks.Task<RegisterNewCustomerResponse> RegisterNewCustomerAsync(RegisterNewCustomerRequest request)
        {
            return base.Channel.RegisterNewCustomerAsync(request);
        }

        public System.Threading.Tasks.Task<GetCustomerInfoResponse> GetCustomerInfoAsync(GetCustomerInfoRequest request)
        {
        ...
        public System.Threading.Tasks.Task<GetVersionResponse> GetVersionAsync(GetVersionRequest request)
        {
            return base.Channel.GetVersionAsync(request);
        }

        public System.Threading.Tasks.Task<GetLocationsResponse> GetLocationsAsync(GetLocationsRequest request)
        {
            return base.Channel.GetLocationsAsync(request);
        }

        public System.Threading.Tasks.Task<GetCamerasResponse> GetCamerasAsync(GetCamerasRequest request)
        {
            return base.Channel.GetCamerasAsync(request);
        }

        public System.Threading.Tasks.Task<SetLocationResponse> SetLocationAsync(SetLocationRequest request)
        {
            return base.Channel.SetLocationAsync(request);
        }

        public System.Threading.Tasks.Task<SetCameraResponse> SetCameraAsync(SetCameraRequest request)
        {
            return base.Channel.SetCameraAsync(request);
        }

        public System.Threading.Tasks.Task<SetAlarmResponse> SetAlarmAsync(SetAlarmRequest request)
        {
            return base.Channel.SetAlarmAsync(request);
        }

        public System.Threading.Tasks.Task<PushRegisterDeviceResponse> PushRegisterDeviceAsync(PushRegisterDeviceRequest request)
        {
            return base.Channel.PushRegisterDeviceAsync(request);
        }

        public System.Threading.Tasks.Task<PushMessageResponse> PushMessageAsync(PushMessageRequest request)
        {
            return base.Channel.PushMessageAsync(request);
        }

        public System.Threading.Tasks.Task<SyncCamerasResponse> SyncCamerasAsync(SyncCamerasRequest request)
        {
            return base.Channel.SyncCamerasAsync(request);
        }

        public System.Threading.Tasks.Task<GetNotificationsResponse> GetNotificationsAsync(GetNotificationsRequest request)
        {
            return base.Channel.GetNotificationsAsync(request);
        }

        public System.Threading.Tasks.Task<GetNotificationsCountResponse> GetNotificationsCountAsync(GetNotificationsCountRequest request)
        {
            return base.Channel.GetNotificationsCountAsync(request);
        }

        public System.Threading.Tasks.Task<AddClipResponse> AddClipAsync(AddClipRequest request)
        {
            return base.Channel.AddClipAsync(request);
        }

        public System.Threading.Tasks.Task<GetClipsResponse> GetClipsAsync(GetClipsRequest request)
        {
            return base.Channel.GetClipsAsync(request);
        }

        public System.Threading.Tasks.Task<GetClipsCountResponse> GetClipsCountAsync(GetClipsCountRequest request)
        {
            return base.Channel.GetClipsCountAsync(request);
        }

        public System.Threading.Tasks.Task<DeleteNotificationResponse> DeleteNotificationAsync(DeleteNotificationRequest request)
        {
        ...
        public System.Threading.Tasks.Task<CryptResponse> CryptAsync(CryptRequest request)
        {
